...
class _PostDetailLoaderState extends State<PostDetailLoader> {
  ...
  Future<PostDetail> fetchPostDetail() async {
    ...
    final response = await http.get(Uri.parse('https://${baseUrl}/board/findBoard/${widget.postId}'));
  ...
  Future<bool> sendCommentToBackend(CommentWidget newComment, int postid) async {
    ...
    try {
      final response = await http.post(
          Uri.parse('https://${baseUrl}/user/comment/save/${postid}'), // Replace with the actual URL
          body: jsonEncode({
